...
public class JDFAyudaProveedores extends javax.swing.JDialog {
    private int idProveedor=0;

    public JDFAyudaProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jBtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnBuscarActionPerformed
        try {
            ...
            int activo=1;
            Proveedores objPro = new Proveedores(0, jTxtRUT.getText(), jTxtNombre.getText(), "", "", "", "", "", "", "");
    ...
    private void jBtnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAceptarActionPerformed
        try {
            ...
            if(i==-1){
                ...
                idProveedor = Integer.parseInt(String.valueOf(jTableProductos.getValueAt(i,0)));
                this.dispose();
            }
        }catch(Exception e){
